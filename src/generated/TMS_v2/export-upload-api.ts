...
export const ExportUploadApi = {
   ...
   */
  nodeExportByNameV2: (body: NodeExportBodyEntityName) =>
    new OpenApiRequestBuilder<ExportEntity>('post', '/nodes/export', {
      body
    }),
  /**
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  nodeUploadByNameV2: (body: NodeExportBodyEntityName) =>
    new OpenApiRequestBuilder<ExportEntity>('post', '/nodes/upload', {
      body
    })
};
